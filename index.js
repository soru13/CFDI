...
$( '#FormularioProductos' ).on( 'pageinit',function(event){
   $.getJSON( "http://10.17.1.200:8000/api/v1/UnidadesMedida/", function(data) {
...
$( '#FormularioCuentaClientes' ).on( 'pageinit',function(event){
  $.getJSON( "http://10.17.1.200:8000/api/v1/Bancos/", function(data) {
...
$( '#Facturacion' ).on( 'pageinit',function(event){
             ...
             $.getJSON( "http://10.17.1.200:8000/api/v1/CuentasClientes/", function(data) {
              ...
              $.getJSON( "http://10.17.1.200:8000/api/v1/Monedas/", function(data) {
              ...
              $.getJSON( "http://10.17.1.200:8000/api/v1/FormasPago/", function(data) {
           ...
           $("#calcular").click(function(e){
            ...
            $('#formLinea').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Lineas/',
                    type: 'POST',
                   ...
                   beforeSend: function(){
                    ...
                    success: function(data) {
                        ...
                        $("#popupBasic p").text("Guardado Con Exito");
                        $("#popupBasic").popup( "open" );
                    },
                    error:function(data){
                        $("#popupBasic p").text("Ya Existe");
                        $("#popupBasic").popup( "open" );
                    },
                });
            });
            $('#formMoneda').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Monedas/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formPago').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/FormasPago/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formMedida').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/UnidadesMedida/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formBancos').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Bancos/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formEmpresa').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Empresas/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formProducto').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Productos/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formCliente').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Clientes/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formCuentaClientes').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/CuentasClientes/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
            ...
            $('#formFacturas').submit(function(e){
                ...
                $.ajax({
                    url: 'http://10.17.1.200:8000/api/v1/Facturas/',
                    type: 'POST',
                    contentType: 'application/json',
                    data: data,
                    dataType: 'json',
        ...
        function tipoList(param){
            if (param == 'Linea') {
                ...
                $.getJSON( "http://10.17.1.200:8000/api/v1/Lineas/", function(data) {
            ...
            if (param == 'Empresa') {
                ...
                $.getJSON( "http://10.17.1.200:8000/api/v1/Empresas/", function(data) {
